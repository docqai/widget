...
var useEmbed = function useEmbed(opened) {
  hooks_module_p(function () {
    ...
    frame.setAttribute('src', "".concat(__URL, "/widget?embedded=true&session=").concat(__session_id, "&space=").concat(__SID));
