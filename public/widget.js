...
var useEmbed = function useEmbed(opened) {
  hooks_module_p(function () {
    ...
    frame.setAttribute('src', "".concat(__URL, "/widget?embedded=true&id=").concat(__session_id));
